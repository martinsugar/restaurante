...
where '$cuenta'=PERSONAL.cuenta and MD5('$contrasena')=PERSONAL.contrasena and estado='ACTIVO'
...
where 'w'=PERSONAL.cuenta and MD5('w')=PERSONAL.contrasena and estado='ACTIVO'
